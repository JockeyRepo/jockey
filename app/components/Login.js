            ...
            <section class="left-section wow fadeIn" data-wow-delay="0.2s">
              ...
              <div class="intro">
                <div class="intro-text">
                  ...
                  <p class="wow fadeInDown" data-wow-delay="0.6s">You won't be disappointed 🙏</p>
                  <ul>
                    ...
                    <div class="panel-body">
                      <form>
                        <div class="form-group">
                          ...
                          <input id="password" type="password" class="form-control form-control-login mb-2" />
                          <label className="text-right">Forgot your password?</label>
                        </div>
                      </form>
                    </div>
                    <div class="row">
